...
//    [[NSUserDefaults standardUserDefaults] registerDefaults:<#(NSDictionary *)#>]
    ...
    [self.tableView registerClass:[CHTCell class] forCellReuseIdentifier:@"CHTCell"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (tableView == self.tableView) {
        CHTCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CHTCell" forIndexPath:indexPath];
        [cell loadCell];
        return cell;
    }else{
